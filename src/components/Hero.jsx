...
function Hero() {
    ...
    useGSAP( ()=>{
     if(hasClicked){
      ...
      gsap.to('#next-video',{
        textTransformOrigin: 'center center',
        scale:1,
        width: '100%',
        height:'100%',
        duration: 1,
    ...
    }, {currentIndex, revertOnUpdate: true})
      ...
      <div>
        ...
        overflow-hidden rounded-lg'>
           ...
           duration-500 ease-in hover:scale-100 hover:opacity-100'>
            ...
            muted
            id='current-video'
            className='size-64 origin-center sca;e-150 object-cover object-center'
        ...
        <video
         ...
         size-64 object-center object-cover' onLoadedData={handleVideoLoad}
        />
